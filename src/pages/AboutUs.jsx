                ...
                <nav className="relative z-50 px-6 py-4 backdrop-blur-sm bg-[#0f0f0f]/80 border-b border-gray-800">
                    <div className="max-w-7xl mx-auto flex justify-between items-center">
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            ...
                            <a href="/about" className="text-white font-semibold border-b-2 border-white pb-1">About Us</a>
                    ...
                    {open && (
                        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="md:hidden mt-6 flex flex-col gap-4 pb-4">
                            ...
                            <a href="/services" className="text-gray-300 hover:text-white font-medium text-center py-2">Services</a>
                            <a href="/about" className="text-white font-semibold text-center py-2">About Us</a>
